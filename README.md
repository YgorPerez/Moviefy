...
It uses an api to fetch the data from the movies.
...
-   <a href="https://axios-http.com/"> Axios
    <img height="20px" src="https://axios-http.com/assets/favicon.ico" alt="Axios logo">
    </a>
